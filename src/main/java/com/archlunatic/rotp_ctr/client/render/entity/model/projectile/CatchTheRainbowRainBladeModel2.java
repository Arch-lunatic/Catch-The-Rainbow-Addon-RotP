...
public class CatchTheRainbowRainBladeModel2 extends EntityModel<CatchTheRainbowRainBladeEntity2> {

    private final ModelRenderer waterCutter;//Todo дождаться 2 модельки
    public CatchTheRainbowRainBladeModel2() {
    ...
    @Override
    public void setupAnim(CatchTheRainbowRainBladeEntity2 entity, float walkAnimPos, float walkAnimSpeed, float ticks, float yRotationOffset, float xRotation) {
