...
public class CtRRevolverBulletEntity extends ModdedProjectileEntity {

    public CtRRevolverBulletEntity(LivingEntity shooter, World world) {
        super(ModEntityTypes.TOMMY_GUN_BULLET.get(), shooter, world);
    }

    public CtRRevolverBulletEntity(EntityType<? extends TommyGunBulletEntity> type, World world) {
        super(type, world);
    }
