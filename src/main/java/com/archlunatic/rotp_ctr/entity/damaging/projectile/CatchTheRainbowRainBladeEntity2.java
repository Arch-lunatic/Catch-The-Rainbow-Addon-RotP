...
public class CatchTheRainbowRainBladeEntity2 extends ModdedProjectileEntity {

    public CatchTheRainbowRainBladeEntity2(EntityType<CatchTheRainbowRainBladeEntity2> type, World world) {
        super(type, world);
    }

    public CatchTheRainbowRainBladeEntity2(LivingEntity shooter, World world) {super(InitEntities.CTR_RAIN_BLADE2.get(), shooter, world);}
